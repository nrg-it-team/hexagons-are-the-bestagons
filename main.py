...
while True:
    ...
    teams = data.get_csv_data("dummydata")
    ...
    #print(auto_cone_max,teleop_cone_max,cycle_time_min,auto_cube_max,teleop_cone_max,auto_balance_max)
    team = "Bionic Black Hawks - 2834" # define this part
    values = teams[team]
    print(values[2])
